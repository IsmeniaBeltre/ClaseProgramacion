...
namespace Rocio2
{
    public partial class FASE1 : Form
    {
        ...
        public FASE1()
        {
            ...
            gunaDataGridView1.EditMode = DataGridViewEditMode.EditOnKeystrokeOrF2;
            gunaDataGridView1.KeyDown += gunaDataGridView1_KeyDown;

          

            gunaDataGridView1.Columns[0].Name = "ID"; // Asigna el nombre de la columna "ID".
            gunaDataGridView1.Columns[0].DataPropertyName = "ID"; // Asigna el nombre del campo en el origen de datos.
