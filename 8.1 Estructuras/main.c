...
forma en que se tiene acceso a los campos de las variables de tipo estrucctura
 tanto para asignción de valores como para lectura y escritura.*/
...
void main (void)
{
    ...
    ➥variable. a1, a2y a3son variables de tipo estructura alumno. */
    ...
    /*Observe la forma en que se imprime los campos de a1 y a2. */
    printf ("\nDatos del alumno 1\n");
    printf ("%d\n", a1.matricula);
    puts (a1.nombre);
    puts (a1.carrera);
    ...
    /* Observa otra forma de escribir los campos de la variable de tipo estructuraa3. */
    printf("\nDatos del alumno 3\n");
