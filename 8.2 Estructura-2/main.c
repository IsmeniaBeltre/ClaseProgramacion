...
void Lectura(struct alumno*);      /*Prototipo de la función*/
...
int main(void)
{
    ...
    a4 = &a0; /*Nota que al apuntador a4 es necesario asignarle una dirección de memoria.
    ...
    Lectura(&a6); /*En este caso se pasa la variable de tipo estructura a6,
    ...
    free(a5); /* Liberar la memoria asignada a5 con malloc. */
    return 0;
}
